...
namespace server
{
    ...
    void enddemoplayback()
    {
        ...
        endfile = openutf8file("../trajectories/record_end_file.csv", "w");
    ...
    void setupdemoplayback()
    {
        ...
        else
        {
            ...
            else if(hdr.protocol!=259) formatstring(msg, "demo \"%s\" requires an %s version of Cube 2: Sauerbraten", file, hdr.protocol<PROTOCOL_VERSION ? "older" : "newer");
        }
        if(msg[0])
        {
            DELETEP(demoplayback);
        ...
        outputfile = openutf8file("../trajectories/trajectorie.csv", "w");
    }
